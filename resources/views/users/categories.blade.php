...
@section('title')
  <title>e-NYUMBANI : <?php echo ucfirst($type->name);?></title>
@endsection
@section('content')
    ...
    <section id="section-body">
        <div class="container">
            <div class="page-title breadcrumb-top">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb"><li ><a href="/"><i class="fa fa-home"></i></a></li><li class="active">{{$type->name}} – Listings</li></ol>
                    ...
                    <div id="content-area">
                        ...
                        <div class="property-listing list-view">
                            ...
                            <div class="row">
                                ...
                                @endforeach
                                @else
                                No Properties under this category, please add properties!
                                @endif
                            </div>
                        </div>
                        <!--end property items-->
