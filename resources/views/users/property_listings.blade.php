...
@section('title')
  <title>e-NYUMBANI : Property Listings</title>
@endsection
@section('content')
    ...
    <section id="section-body">
        <div class="container">
            <div class="page-title breadcrumb-top">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb"><li ><a href="/"><i class="fa fa-home"></i></a></li><li class="active">All – Listings</li></ol>
                    ...
                    <div id="content-area">
                        ...
                        <div class="list-tabs table-list full-width">
                            <div class="tabs table-cell">
                                <ul>
                                    <li>
                                        <a href="{{route('listings.all')}}" class="@if($t=='all') active @endif">ALL</a>
                                    </li>
                                    <li>
                                        <a href="{{route('listings.sale')}}" class="@if($t=='sale') active @endif">FOR SALE</a>
                                    </li>
                                    <li>
                                        <a href="{{route('listings.rent')}}" class="@if($t=='rent') active @endif">FOR RENT</a>
                                    </li>
                                </ul>
                            </div>
