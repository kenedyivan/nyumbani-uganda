...
<head>
    ...
    <meta name="keywords" content="e-NYUMBANI, Get your baest house offer, trusted blockers, cheap houses, great accomodation!">
    ...
    <div class="header-mobile visible-sm visible-xs" style="background:white;">
        <div class="container">
            ...
            <div class="header-logo">
                <a href="/"><img src="/uploads/logo6.png" alt="logo" style="object-fit: cover;" width="100" height="350"></a>
            </div>
                    ...
                    <li>
                        ...
                        <div class="account-dropdown">
                            <ul>
                                  ...
                                  <li><a href="{{route('agent.register.form')}}"><i class="fa fa-user"></i> Register</a></li>
                                  <li><a href="{{route('agent.create.listing')}}" class="btn btn-default"><i class="fa fa-plus-circle"></i> Create Listing</a></li>
                                @endif
