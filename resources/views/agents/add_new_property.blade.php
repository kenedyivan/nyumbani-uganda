                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <div class="membership-page-title">
                            ...
                            <p class="page-subtitle"> Please enter your Account and Billing information to complete your
                                membership! </p>
                        </div>
                        <ol class="pay-step-bar">
                            <li class="pay-step-block"><span>1. Select Package</span></li>
                            <li class="pay-step-block active"><span>2. <span class="hidden-xs">Listing</span></span>
                            </li>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="property-title"
                                                       name="title" placeholder="Enter your property title"
                                                       value="acacia resort" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" rows="6"
                                                          name="description"
                                                          placeholder="Enter your property description" required>Just some description</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="account-block">
                            ...
                            <div class="add-tab-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="property-size-prefix"
                                                               name="size_prefix"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="property-bedrooms"
                                                               name="bedrooms"
                                ...
                                <div class="account-block text-right">
                                    ...
                                    <button type="submit" id="add-property" class="btn btn-primary">Submit Property
                                    </button>
                                </div>
                    </form>
                </div>
            ...
            if (window.File && window.FileList && window.FileReader) {
                ...
                filesInput.addEventListener("change", function (event) {
                    ...
                    if (all.length == 6) {
                        ...
                        document.getElementById('files').return;
                    }
